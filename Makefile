...
mkmapper: raylib
ifneq (,$(mkmapper_config))
	@echo "==== Building mkmapper ($(mkmapper_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f mkmapper.make config=$(mkmapper_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f mkmapper.make clean
